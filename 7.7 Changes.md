...
## COMAPI Can Create New Measurment Files
...
## Worksheet items can be arranged
...
### New in WinDarab is the support to open different files as a linked file – even the recording configurations are different  <!-- omit in toc -->
...
### To complete the support, the file extract functions were refactored  <!-- omit in toc -->
